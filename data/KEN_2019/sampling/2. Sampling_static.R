...
dev.off()
ggsave("3a.Dynamics_historical_KEN.pdf",
...
dev.off()
ggsave("3b.Dynamics_historical_deviation_from_trend_KEN.pdf",
       marrangeGrob(together, nrow = 2, ncol = 1))
...
dev.off()
ggsave(filename="3c. Density_of_sampled_shocks_KEN.pdf", 
...
dev.off()
ggsave("3d.Dynamics_historical_with_sampled_intervals_KEN.pdf",
       marrangeGrob(together, nrow = 2, ncol = 1))
...
write.csv(shocks,'4.Sampled_scenarios_KEN.csv')
