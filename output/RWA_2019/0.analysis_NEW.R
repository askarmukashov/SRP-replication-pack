...
shocks <- as.data.frame(read_excel(path = 
                                     "C:/Work/AI/historical_uncertainty/data/rwa_2019/2sampled_scenarios_rwa_2019.xlsx", 
                                   sheet = "scenarios"))
...
MACROTAB <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                                     sheet = "MACROTABX"))
...
PH <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                               sheet = "PH"))
names(PH)[1:2] <- c("X", "T")
PH <- subset(PH, X != 'base')
PH <- subset(PH, X != 0)
...
gdp_AFS <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                                    sheet = "gdp_AFS"))
...
gdp_sect <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                                     sheet = "gdp_nonag"))
...
HHD_CONS <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                                    sheet = "HHD_CONS_X"))
...
model_stat <- as.data.frame(read_excel(path =  "rwa_2019_STATIC.xlsx", 
                                       sheet = "model_stat"))
...
# Load the data
desc <- as.data.frame(read_excel(path = "C:/Work/AI/historical_uncertainty/data/rwa_2019/2sampled_scenarios_rwa_2019.xlsx", 
                                 sheet = "desc"))
